...
public class RunCreateSchemaExtended {
  ...
  public RunCreateSchemaExtended() {
  }

  public RunCreateSchemaExtended name(String name) {
  ...
  **/
  ...
  public RunCreateSchemaExtended inputs(Inputs inputs) {
  ...
  **/
  ...
  public RunCreateSchemaExtended runType(RunTypeEnum runType) {
  ...
  **/
  ...
  public RunCreateSchemaExtended startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  public RunCreateSchemaExtended endTime(OffsetDateTime endTime) {
  ...
  **/
  ...
  public RunCreateSchemaExtended extra(Object extra) {
  ...
  **/
  ...
  public RunCreateSchemaExtended error(String error) {
  ...
  **/
  ...
  public RunCreateSchemaExtended executionOrder(Integer executionOrder) {
  ...
  **/
  ...
  public RunCreateSchemaExtended serialized(Object serialized) {
  ...
  **/
  ...
  public RunCreateSchemaExtended outputs(Outputs outputs) {
  ...
  **/
  ...
  public RunCreateSchemaExtended parentRunId(UUID parentRunId) {
  ...
  **/
  ...
  public RunCreateSchemaExtended manifestId(UUID manifestId) {
  ...
  **/
  ...
  public RunCreateSchemaExtended events(List<Object> events) {
    
    this.events = events;
    return this;
  }

  public RunCreateSchemaExtended addEventsItem(Object eventsItem) {
    if (this.events == null) {
  ...
  **/
  ...
  public RunCreateSchemaExtended tags(List<String> tags) {
    
    this.tags = tags;
    return this;
  }

  public RunCreateSchemaExtended addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public RunCreateSchemaExtended id(UUID id) {
  ...
  **/
  ...
  public RunCreateSchemaExtended sessionId(UUID sessionId) {
  ...
  **/
  ...
  public RunCreateSchemaExtended sessionName(String sessionName) {
  ...
  **/
  ...
  public RunCreateSchemaExtended childRuns(List<RunCreateSchema> childRuns) {
    
    this.childRuns = childRuns;
    return this;
  }

  public RunCreateSchemaExtended addChildRunsItem(RunCreateSchema childRunsItem) {
  ...
  **/
  ...
  public RunCreateSchemaExtended referenceExampleId(UUID referenceExampleId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RunCreateSchemaExtended runCreateSchemaExtended = (RunCreateSchemaExtended) o;
    return Objects.equals(this.name, runCreateSchemaExtended.name) &&
        Objects.equals(this.inputs, runCreateSchemaExtended.inputs) &&
        Objects.equals(this.runType, runCreateSchemaExtended.runType) &&
        Objects.equals(this.startTime, runCreateSchemaExtended.startTime) &&
        Objects.equals(this.endTime, runCreateSchemaExtended.endTime) &&
        Objects.equals(this.extra, runCreateSchemaExtended.extra) &&
        Objects.equals(this.error, runCreateSchemaExtended.error) &&
        Objects.equals(this.executionOrder, runCreateSchemaExtended.executionOrder) &&
        Objects.equals(this.serialized, runCreateSchemaExtended.serialized) &&
        Objects.equals(this.outputs, runCreateSchemaExtended.outputs) &&
        Objects.equals(this.parentRunId, runCreateSchemaExtended.parentRunId) &&
        Objects.equals(this.manifestId, runCreateSchemaExtended.manifestId) &&
        Objects.equals(this.events, runCreateSchemaExtended.events) &&
        Objects.equals(this.tags, runCreateSchemaExtended.tags) &&
        Objects.equals(this.id, runCreateSchemaExtended.id) &&
        Objects.equals(this.sessionId, runCreateSchemaExtended.sessionId) &&
        Objects.equals(this.sessionName, runCreateSchemaExtended.sessionName) &&
        Objects.equals(this.childRuns, runCreateSchemaExtended.childRuns) &&
        Objects.equals(this.referenceExampleId, runCreateSchemaExtended.referenceExampleId);
  }
  ...
  public String toString() {
    ...
    sb.append("class RunCreateSchemaExtended {\n");
