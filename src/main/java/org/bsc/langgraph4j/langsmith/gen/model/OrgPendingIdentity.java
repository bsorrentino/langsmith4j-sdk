 ...
 */
@JsonPropertyOrder({
  OrgPendingIdentity.JSON_PROPERTY_EMAIL,
  OrgPendingIdentity.JSON_PROPERTY_READ_ONLY,
  OrgPendingIdentity.JSON_PROPERTY_ROLE_ID,
  OrgPendingIdentity.JSON_PROPERTY_WORKSPACE_IDS,
  OrgPendingIdentity.JSON_PROPERTY_WORKSPACE_ROLE_ID,
  OrgPendingIdentity.JSON_PROPERTY_PASSWORD,
  OrgPendingIdentity.JSON_PROPERTY_FULL_NAME,
  OrgPendingIdentity.JSON_PROPERTY_ACCESS_SCOPE,
  OrgPendingIdentity.JSON_PROPERTY_ID,
  OrgPendingIdentity.JSON_PROPERTY_USER_ID,
  OrgPendingIdentity.JSON_PROPERTY_TENANT_ID,
  OrgPendingIdentity.JSON_PROPERTY_ORGANIZATION_ID,
  OrgPendingIdentity.JSON_PROPERTY_CREATED_AT,
  OrgPendingIdentity.JSON_PROPERTY_ROLE_NAME,
  OrgPendingIdentity.JSON_PROPERTY_ORG_ROLE_ID,
  OrgPendingIdentity.JSON_PROPERTY_ORG_ROLE_NAME,
  OrgPendingIdentity.JSON_PROPERTY_TENANT_IDS
})
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2025-08-17T23:27:07.599378+02:00[Europe/Rome]", comments = "Generator version: 7.14.0")
public class OrgPendingIdentity {
  ...
  public OrgPendingIdentity email(@javax.annotation.Nonnull String email) {
    this.email = email;
    return this;
  }
  ...
  public OrgPendingIdentity readOnly(@javax.annotation.Nullable Boolean readOnly) {
  ...
  public OrgPendingIdentity roleId(@javax.annotation.Nullable UUID roleId) {
  ...
  public OrgPendingIdentity workspaceIds(@javax.annotation.Nullable List<UUID> workspaceIds) {
    this.workspaceIds = JsonNullable.<List<UUID>>of(workspaceIds);
    return this;
  }

  public OrgPendingIdentity addWorkspaceIdsItem(UUID workspaceIdsItem) {
  ...
  public OrgPendingIdentity workspaceRoleId(@javax.annotation.Nullable UUID workspaceRoleId) {
  ...
  public OrgPendingIdentity password(@javax.annotation.Nullable String password) {
  ...
  public OrgPendingIdentity fullName(@javax.annotation.Nullable String fullName) {
  ...
  public OrgPendingIdentity accessScope(@javax.annotation.Nullable AccessScope accessScope) {
  ...
  public OrgPendingIdentity id(@javax.annotation.Nonnull UUID id) {
    this.id = id;
    return this;
  }
  ...
  public OrgPendingIdentity userId(@javax.annotation.Nullable UUID userId) {
  ...
  public OrgPendingIdentity tenantId(@javax.annotation.Nullable UUID tenantId) {
  ...
  public OrgPendingIdentity organizationId(@javax.annotation.Nullable UUID organizationId) {
  ...
  public OrgPendingIdentity createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public OrgPendingIdentity roleName(@javax.annotation.Nullable String roleName) {
  ...
  public OrgPendingIdentity orgRoleId(@javax.annotation.Nullable UUID orgRoleId) {
  ...
  public OrgPendingIdentity orgRoleName(@javax.annotation.Nullable String orgRoleName) {
  ...
  public OrgPendingIdentity tenantIds(@javax.annotation.Nullable List<UUID> tenantIds) {
    this.tenantIds = tenantIds;
    return this;
  }

  public OrgPendingIdentity addTenantIdsItem(UUID tenantIdsItem) {
  ...
  /**
   * Return true if this OrgPendingIdentity object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    OrgPendingIdentity orgPendingIdentity = (OrgPendingIdentity) o;
    return Objects.equals(this.email, orgPendingIdentity.email) &&
        Objects.equals(this.readOnly, orgPendingIdentity.readOnly) &&
        equalsNullable(this.roleId, orgPendingIdentity.roleId) &&
        equalsNullable(this.workspaceIds, orgPendingIdentity.workspaceIds) &&
        equalsNullable(this.workspaceRoleId, orgPendingIdentity.workspaceRoleId) &&
        equalsNullable(this.password, orgPendingIdentity.password) &&
        equalsNullable(this.fullName, orgPendingIdentity.fullName) &&
        Objects.equals(this.accessScope, orgPendingIdentity.accessScope) &&
        Objects.equals(this.id, orgPendingIdentity.id) &&
        equalsNullable(this.userId, orgPendingIdentity.userId) &&
        equalsNullable(this.tenantId, orgPendingIdentity.tenantId) &&
        equalsNullable(this.organizationId, orgPendingIdentity.organizationId) &&
        Objects.equals(this.createdAt, orgPendingIdentity.createdAt) &&
        equalsNullable(this.roleName, orgPendingIdentity.roleName) &&
        equalsNullable(this.orgRoleId, orgPendingIdentity.orgRoleId) &&
        equalsNullable(this.orgRoleName, orgPendingIdentity.orgRoleName) &&
        Objects.equals(this.tenantIds, orgPendingIdentity.tenantIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrgPendingIdentity {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    private OrgPendingIdentity instance;

    public Builder() {
      this(new OrgPendingIdentity());
    }

    protected Builder(OrgPendingIdentity instance) {
      this.instance = instance;
    }

    public OrgPendingIdentity.Builder email(String email) {
      this.instance.email = email;
      return this;
    }
    public OrgPendingIdentity.Builder readOnly(Boolean readOnly) {
      this.instance.readOnly = readOnly;
      return this;
    }
    public OrgPendingIdentity.Builder roleId(UUID roleId) {
      this.instance.roleId = JsonNullable.<UUID>of(roleId);
      return this;
    }
    public OrgPendingIdentity.Builder roleId(JsonNullable<UUID> roleId) {
      this.instance.roleId = roleId;
      return this;
    }
    public OrgPendingIdentity.Builder workspaceIds(List<UUID> workspaceIds) {
      this.instance.workspaceIds = JsonNullable.<List<UUID>>of(workspaceIds);
      return this;
    }
    public OrgPendingIdentity.Builder workspaceIds(JsonNullable<List<UUID>> workspaceIds) {
      this.instance.workspaceIds = workspaceIds;
      return this;
    }
    public OrgPendingIdentity.Builder workspaceRoleId(UUID workspaceRoleId) {
      this.instance.workspaceRoleId = JsonNullable.<UUID>of(workspaceRoleId);
      return this;
    }
    public OrgPendingIdentity.Builder workspaceRoleId(JsonNullable<UUID> workspaceRoleId) {
      this.instance.workspaceRoleId = workspaceRoleId;
      return this;
    }
    public OrgPendingIdentity.Builder password(String password) {
      this.instance.password = JsonNullable.<String>of(password);
      return this;
    }
    public OrgPendingIdentity.Builder password(JsonNullable<String> password) {
      this.instance.password = password;
      return this;
    }
    public OrgPendingIdentity.Builder fullName(String fullName) {
      this.instance.fullName = JsonNullable.<String>of(fullName);
      return this;
    }
    public OrgPendingIdentity.Builder fullName(JsonNullable<String> fullName) {
      this.instance.fullName = fullName;
      return this;
    }
    public OrgPendingIdentity.Builder accessScope(AccessScope accessScope) {
      this.instance.accessScope = accessScope;
      return this;
    }
    public OrgPendingIdentity.Builder id(UUID id) {
      this.instance.id = id;
      return this;
    }
    public OrgPendingIdentity.Builder userId(UUID userId) {
      this.instance.userId = JsonNullable.<UUID>of(userId);
      return this;
    }
    public OrgPendingIdentity.Builder userId(JsonNullable<UUID> userId) {
      this.instance.userId = userId;
      return this;
    }
    public OrgPendingIdentity.Builder tenantId(UUID tenantId) {
      this.instance.tenantId = JsonNullable.<UUID>of(tenantId);
      return this;
    }
    public OrgPendingIdentity.Builder tenantId(JsonNullable<UUID> tenantId) {
      this.instance.tenantId = tenantId;
      return this;
    }
    public OrgPendingIdentity.Builder organizationId(UUID organizationId) {
      this.instance.organizationId = JsonNullable.<UUID>of(organizationId);
      return this;
    }
    public OrgPendingIdentity.Builder organizationId(JsonNullable<UUID> organizationId) {
      this.instance.organizationId = organizationId;
      return this;
    }
    public OrgPendingIdentity.Builder createdAt(OffsetDateTime createdAt) {
      this.instance.createdAt = createdAt;
      return this;
    }
    public OrgPendingIdentity.Builder roleName(String roleName) {
      this.instance.roleName = JsonNullable.<String>of(roleName);
      return this;
    }
    public OrgPendingIdentity.Builder roleName(JsonNullable<String> roleName) {
      this.instance.roleName = roleName;
      return this;
    }
    public OrgPendingIdentity.Builder orgRoleId(UUID orgRoleId) {
      this.instance.orgRoleId = JsonNullable.<UUID>of(orgRoleId);
      return this;
    }
    public OrgPendingIdentity.Builder orgRoleId(JsonNullable<UUID> orgRoleId) {
      this.instance.orgRoleId = orgRoleId;
      return this;
    }
    public OrgPendingIdentity.Builder orgRoleName(String orgRoleName) {
      this.instance.orgRoleName = JsonNullable.<String>of(orgRoleName);
      return this;
    }
    public OrgPendingIdentity.Builder orgRoleName(JsonNullable<String> orgRoleName) {
      this.instance.orgRoleName = orgRoleName;
      return this;
    }
    public OrgPendingIdentity.Builder tenantIds(List<UUID> tenantIds) {
    ...
    /**
    * returns a built OrgPendingIdentity instance.
    *
    * The builder is not reusable.
    */
    public OrgPendingIdentity build() {
      try {
  ...
  */
  public static OrgPendingIdentity.Builder builder() {
    return new OrgPendingIdentity.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public OrgPendingIdentity.Builder toBuilder() {
    return new OrgPendingIdentity.Builder()
      .email(getEmail())
