...
@JsonDeserialize(using=Value2.Value2Deserializer.class)
@JsonSerialize(using = Value2.Value2Serializer.class)
public class Value2 extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Value2.class.getName());

    public static class Value2Serializer extends StdSerializer<Value2> {
        public Value2Serializer(Class<Value2> t) {
            super(t);
        }

        public Value2Serializer() {
            this(null);
        }

        @Override
        public void serialize(Value2 value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class Value2Deserializer extends StdDeserializer<Value2> {
        public Value2Deserializer() {
            this(Value2.class);
        }

        public Value2Deserializer(Class<?> vc) {
            super(vc);
        }

        @Override
        public Value2 deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                Value2 ret = new Value2();
                ret.setActualInstance(deserialized);
                return ret;
            } catch (Exception e) {
                // deserialization failed, continue, log to help debugging
                log.log(Level.FINER, "Input data does not match 'Value2'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for Value2: no match found"));
        }
         ...
         */
        @Override
        public Value2 getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public Value2(BigDecimal o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public Value2(Boolean o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public Value2(Integer o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public Value2(String o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(Value2.class, Collections.unmodifiableMap(schemas));
    }

    @Override
    public Map<String, Class<?>> getSchemas() {
        return Value2.schemas;
    }
