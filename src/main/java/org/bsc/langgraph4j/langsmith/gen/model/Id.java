...
public class Id extends AbstractOpenApiSchema {
    ...
    public static class IdDeserializer extends StdDeserializer<Id> {
        ...
        public Id deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                log.log(Level.FINER, "Input data does not match 'Id'", e);
            }

            throw new IOException(String.format("Failed deserialization for Id: no match found"));
        }
         ...
         */
        @Override
        public Id getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    static {
        ...
        JSON.registerDescendants(Id.class, Collections.unmodifiableMap(schemas));
    }
