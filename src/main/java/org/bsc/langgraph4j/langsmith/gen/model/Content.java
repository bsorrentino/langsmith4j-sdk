...
@JsonSerialize(using = Content.ContentSerializer.class)
public class Content extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Content.class.getName());

    public static class ContentSerializer extends StdSerializer<Content> {
        public ContentSerializer(Class<Content> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(Content value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
            jgen.writeObject(value.getActualInstance());
        }
    }

    public static class ContentDeserializer extends StdDeserializer<Content> {
        ...
        public Content deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                log.log(Level.FINER, "Input data does not match 'Content'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for Content: no match found"));
        }
         ...
         */
        @Override
        public Content getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            throw new JsonMappingException(ctxt.getParser(), "Content cannot be null");
        }
    }
    ...
    public Content(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    static {
        schemas.put("List<ContentAnyOfInner>", List.class);
     ...
     */
    public List<ContentAnyOfInner> getList() throws ClassCastException {
