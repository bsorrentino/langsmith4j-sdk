...
@JsonSerialize(using = Description.DescriptionSerializer.class)
public class Description extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(Description.class.getName());

    public static class DescriptionSerializer extends StdSerializer<Description> {
        public DescriptionSerializer(Class<Description> t) {
            super(t);
        }
        ...
        @Override
        public void serialize(Description value, JsonGenerator jgen, SerializerProvider provider) throws IOException, JsonProcessingException {
    ...
    public static class DescriptionDeserializer extends StdDeserializer<Description> {
        ...
        public Description deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                log.log(Level.FINER, "Input data does not match 'Description'", e);
            }
            ...
            throw new IOException(String.format("Failed deserialization for Description: no match found"));
        }
         ...
         */
        @Override
        public Description getNullValue(DeserializationContext ctxt) throws JsonMappingException {
            return null;
        }
    }
    ...
    public Description(Missing o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }

    public Description(String o) {
        super("anyOf", Boolean.TRUE);
        setActualInstance(o);
    }
    ...
    static {
        ...
        JSON.registerDescendants(Description.class, Collections.unmodifiableMap(schemas));
    }
