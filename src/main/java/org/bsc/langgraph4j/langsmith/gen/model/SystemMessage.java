...
@JsonPropertyOrder({
  ...
  SystemMessage.JSON_PROPERTY_ADDITIONAL_KWARGS,
  SystemMessage.JSON_PROPERTY_RESPONSE_METADATA,
  SystemMessage.JSON_PROPERTY_TYPE,
  SystemMessage.JSON_PROPERTY_NAME,
  SystemMessage.JSON_PROPERTY_ID
})
...
public class SystemMessage extends HashMap<String, Object> {
  ...
  public SystemMessage content(@javax.annotation.Nonnull Content content) {
  ...
  public SystemMessage additionalKwargs(@javax.annotation.Nullable Object additionalKwargs) {
  ...
  public SystemMessage responseMetadata(@javax.annotation.Nullable Object responseMetadata) {
  ...
  public SystemMessage type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public SystemMessage name(@javax.annotation.Nullable Name2 name) {
    this.name = name;
    return this;
  }
  ...
  public SystemMessage id(@javax.annotation.Nullable Id id) {
    this.id = id;
    return this;
  }
   ...
   */
  @JsonAnySetter
  public SystemMessage putAdditionalProperty(String key, Object value) {
  ...
  /**
   * Return true if this SystemMessage object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, systemMessage.content) &&
        Objects.equals(this.additionalKwargs, systemMessage.additionalKwargs) &&
        Objects.equals(this.responseMetadata, systemMessage.responseMetadata) &&
        Objects.equals(this.type, systemMessage.type) &&
        Objects.equals(this.name, systemMessage.name) &&
        Objects.equals(this.id, systemMessage.id)&&
        Objects.equals(this.additionalProperties, systemMessage.additionalProperties) &&
        super.equals(o);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    public Builder() {
      this(new SystemMessage());
    }

    protected Builder(SystemMessage instance) {
      this.instance = instance;
    }

    public SystemMessage.Builder content(Content content) {
      this.instance.content = content;
      return this;
    }
    public SystemMessage.Builder additionalKwargs(Object additionalKwargs) {
      this.instance.additionalKwargs = additionalKwargs;
      return this;
    }
    public SystemMessage.Builder responseMetadata(Object responseMetadata) {
      this.instance.responseMetadata = responseMetadata;
      return this;
    }
    public SystemMessage.Builder type(String type) {
      this.instance.type = type;
      return this;
    }
    public SystemMessage.Builder name(Name2 name) {
      this.instance.name = name;
      return this;
    }
    public SystemMessage.Builder id(Id id) {
      this.instance.id = id;
      return this;
    }
    ...
    /**
    * returns a built SystemMessage instance.
    *
  ...
  */
  public static SystemMessage.Builder builder() {
    return new SystemMessage.Builder();
  }
