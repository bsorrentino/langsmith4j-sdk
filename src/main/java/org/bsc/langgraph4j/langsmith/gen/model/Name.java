...
public class Name extends AbstractOpenApiSchema {
    ...
    public static class NameSerializer extends StdSerializer<Name> {
    ...
    public static class NameDeserializer extends StdDeserializer<Name> {
        ...
        public Name deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            try {
                ...
                log.log(Level.FINER, "Input data does not match 'Name'", e);
            }

            throw new IOException(String.format("Failed deserialization for Name: no match found"));
        }
